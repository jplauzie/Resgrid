...
void launch_matvec(
    ...
    cudaStream_t stream);   // CHANGED: added stream parameter
...
void cuda_memcpy_device_to_device_async(void* dst, const void* src, size_t size, cudaStream_t stream); // NEW
